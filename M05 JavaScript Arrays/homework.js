...
function multiplicarArgumentos() {
   ...
   if(arguments.length === 0){
      ...
      for(var i = 0;i<arguments.length; i ++){
         recipiente = recipiente * arguments [i];
      }
   }
   return recipiente;
}
...
function mesesDelAño(array) {
   ...
   }if(arrayResultante.includes("Enero") && arrayResultante.includes("Marzo") && arrayResultante.includes("Noviembre")){
...
function breakStatement(num) {
   ...
   }else if(arrayDenumeros.length ===10){
